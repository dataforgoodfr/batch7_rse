    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(help_text='Nom du secteur', max_length=50, verbose_name='Nom du secteur')),
            ],
        ),
        migrations.CreateModel(
            name='Company',
            fields=[
                ...
                ('sectors', models.ManyToManyField(help_text="Secteurs dans lesquels l'entreprise opére", to='polls.ActivitySector', verbose_name='Secteurs')),
            ],
        ),
        migrations.CreateModel(
            name='DPEF',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('file_object', models.FileField(help_text='Document DPEF ou DDR au format PDF.', unique=True, upload_to='', validators=[polls.models._validate_file_extension], verbose_name='Fichier PDF')),
