...
class DebugConfig:
    ...
    annotations_file = "../data/input/Entreprises/entreprises_rse_annotations.csv"
    parsed_par_file = "../data/processed/DPEFs/dpef_paragraphs_debug.csv"
    parsed_sent_file = "../data/processed/DPEFs/dpef_paragraphs_sentences_debug.csv"
    model_dir = "../data/model_debug/"
    scorer_pickle_file = model_dir + "vectorizer_component/words_scorer.pckl"
