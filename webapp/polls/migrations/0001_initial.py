...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('file_object', models.FileField(help_text='Document DPEF ou DDR au format PDF.', unique=True, upload_to='', validators=[
                    polls.models._validate_file_extension], verbose_name='Fichier PDF')),
